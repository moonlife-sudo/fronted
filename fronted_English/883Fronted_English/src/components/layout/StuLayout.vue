  ...
  setup() {
    ...
    const moduleConfigs = {
      'leave': [
        ...
        { name: 'Leave Records', path: '/student/leave/records' }
      ],
      'resource': [
        { name: 'Available Classrooms', path: '/student/classroom' },
        { name: 'Book Borrowing', path: '/student/library' }
      ],
      'campus': [
        { name: 'Dormitory Allocation', path: '/student/studorm' },
        { name: 'Campus Forum', path: '/student/forum' }
      ]
    }
