        ...
        <div class="dashboard-grid">
          <div class="card stat-card">
              <div class="card-header">
                ...
                <h3>Dormitory Statistics</h3>
              </div>
              <div class="card-body">
                <div class="stat-item">
                  <span class="stat-value">24</span>
                  <span class="stat-label">Total Dormitories</span>
                </div>
                <div class="stat-item">
          ...
          <div class="card quick-action-card">
              ...
              <div class="card-body">
                ...
                <router-link to="/admin/dormassign" class="action-btn">
                  ...
                  <span>Dormitory Assignment</span>
                </router-link>
              </div>
            </div>
          ...
          <div class="card notice-card">
              ...
              <div class="card-body">
                <div class="notice-item">
                  <h4>Dormitory Safety Inspection Notice</h4>
                  <p>A campus-wide dormitory safety inspection will be conducted next Wednesday. Please inform students to prepare in advance.</p>
                  <small>2023-06-15</small>
                </div>
                <div class="notice-item">
                  <h4>Summer Dormitory Arrangements</h4>
                  <p>The summer dormitory arrangement list for students staying on campus has been published. Please check and inform relevant students promptly.</p>
...
export default {
  ...
  methods: {
    ...
    submitPost() {
      ...
      // 这里可以添加实际的提交逻辑
      alert(`Post "${this.post.title}" published successfully!`)
      this.post.title = ''
      this.post.content = ''
    }
  },
