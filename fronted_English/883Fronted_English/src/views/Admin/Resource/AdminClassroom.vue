      ...
      <div class="search-filter">
        ...
        <div class="filter-group">
          ...
          <select v-model="capacityFilter">
            ...
            <option value="small">Small (1-30 people)</option>
            <option value="medium">Medium (31-60 people)</option>
            <option value="large">Large (61+ people)</option>
          </select>
        </div>
      </div>
          ...
          <div class="classroom-body">
            <div class="classroom-info">
              ...
              <div class="classroom-info-item">
                ...
                <span>Equipment: {{ classroom.equipment || 'None' }}</span>
              </div>
              <div class="classroom-info-item">
                ...
                <span>Status: 
                  <span class="classroom-status" :class="{
                    ...
                    {{ classroom.status === 'active' ? 'Available' : 'Inactive' }}
                  </span>
                </span>
              </div>
            </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form @submit.prevent="saveClassroom">
              ...
              <div class="form-group">
                <label for="classroom-location">Location</label>
                <input 
                  type="text" 
              ...
              <div class="form-group">
                <label for="classroom-equipment">Equipment Configuration</label>
                <textarea 
  ...
  data() {
    return {
      ...
      classrooms: [
        {
          id: 1,
          name: "Multimedia Classroom A",
          number: "101",
          capacity: 50,
          location: "Main Teaching Building, 1st Floor",
          equipment: "Projector, Computer, Sound System",
          status: "active"
        },
        {
          id: 2,
        ...
        },
        {
          ...
          equipment: "Conference Table, Projector, Phone",
          status: "inactive"
        },
        {
          id: 4,
          ...
          number: "412",
          capacity: 45,
          location: "Foreign Language Building, 4th Floor",
          equipment: "45 Language Sets",
          status: "active"
        },
        {
          id: 5,
          name: "Art Classroom E",
          number: "108",
          capacity: 25,
          location: "Art Building, 1st Floor",
          equipment: "Easels, Still Life Table",
          status: "active"
        },
        {
          id: 6,
          ...
          capacity: 35,
          location: "Science Building, 2nd Floor",
          equipment: "Lab Tables, Instruments",
          status: "inactive"
        }
      ],
      // 筛选条件
  ...
  methods: {
    ...
    saveClassroom() {
      if (this.editingClassroom) {
        ...
        if (index !== -1) {
          ...
          this.showToast('Classroom updated successfully')
        }
      } else {
        // 添加新教室
        const newClassroom = {
        ...
        this.showToast('Classroom added successfully')
      }
      this.closeModal()
    },
    // 切换教室状态
    toggleStatus(id) {
      ...
      if (index !== -1) {
        ...
        this.showToast(`Classroom has been ${this.classrooms[index].status === 'active' ? 'activated' : 'deactivated'}`)
      }
    },
    // 编辑教室
