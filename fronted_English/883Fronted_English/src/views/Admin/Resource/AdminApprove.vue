      ...
      <div class="search-filter">
        <div class="search-box">
          ...
          <input 
            type="text" 
            v-model="searchTerm"
            placeholder="Search applicant, classroom or date..." 
          >
        </div>
          ...
          <div class="approval-body">
            <div class="approval-info">
              ...
              <div class="approval-info-item">
                ...
                <span>Date: {{ application.date }}</span>
              </div>
              <div class="approval-info-item">
                <i class="bi bi-clock"></i>
                <span>Time: {{ application.time }}</span>
              </div>
              <div class="approval-info-item">
...
export default {
  ...
  data() {
    return {
      ...
      applications: [
        { id: 1,
          type: 'Classroom Reservation Application',
          applicant: 'Teacher Zhang',
        ...
        { id: 3,
          type: 'Classroom Reservation Application',
          applicant: 'Student Wang',
          location: 'Laboratory Building B-105',
          date: '2023-11-20',
          time: '16:00 - 18:00',
          purpose: 'Student Club Activity',
          status: 'pending'
        }
      ]
    }
  ...
  methods: {
    ...
    approveApplication(id) {
      ...
      if (app && confirm('Are you sure you want to approve this application?')) {
        app.status = 'approved'
      }
    },
    ...
    rejectApplication(id) {
      const app = this.applications.find(a => a.id === id)
      if (app && confirm('Are you sure you want to reject this application?')) {
        app.status = 'rejected'
      }
    },
