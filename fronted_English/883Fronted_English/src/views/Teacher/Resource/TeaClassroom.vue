        ...
        <div class="classroom-grid">
          ...
          >
            ...
            <div class="classroom-info">
              ...
              >
                {{ availableTimes(classroom).length === 0 ? 'Fully Booked' : 'Book Now' }}
              </button>
            </div>
          </div>
        </div>
        ...
        <form @submit.prevent="submitBooking">
          ...
          <div class="form-group">
            ...
            <textarea 
              ...
              required
              placeholder="Please enter classroom usage purpose..."
            ></textarea>
          </div>
    ...
    return {
      ...
      classrooms: [
        {
          ...
          image: "https://placeholder.pics/svg/300x200/DEDEDE/555555/Classroom 101",
          schedule: [
        ...
        },
        {
          ...
          image: "https://placeholder.pics/svg/300x200/DEDEDE/555555/Multimedia Classroom 201",
          schedule: [
        ...
        },
        {
          ...
          name: "Laboratory 301",
          capacity: 30,
          location: "Experiment Building, Floor 3",
          image: "https://placeholder.pics/svg/300x200/DEDEDE/555555/Laboratory 301",
          schedule: [
            { date: "2023-06-01", time: "08:00-10:00", available: true },
            { date: "2023-06-01", time: "10:00-12:00", available: true },
        ...
        },
        {
          ...
          image: "https://placeholder.pics/svg/300x200/DEDEDE/555555/Meeting Room 401",
          schedule: [
            { date: "2023-06-01", time: "08:00-10:00", available: true },
            { date: "2023-06-01", time: "10:00-12:00", available: true },
            { date: "2023-06-01", time: "14:00-16:00", available: true }
        ...
        },
        {
          ...
          image: "https://placeholder.pics/svg/300x200/DEDEDE/555555/Auditorium 501",
          schedule: [
            { date: "2023-06-01", time: "08:00-10:00", available: false },
            { date: "2023-06-01", time: "10:00-12:00", available: false },
            { date: "2023-06-01", time: "14:00-16:00", available: true }
        ...
        },
        {
          ...
          image: "https://placeholder.pics/svg/300x200/DEDEDE/555555/Computer Classroom 601",
          schedule: [
            { date: "2023-06-01", time: "08:00-10:00", available: true },
            { date: "2023-06-01", time: "10:00-12:00", available: true },
            { date: "2023-06-01", time: "14:00-16:00", available: false }
      ...
      bookings: [
        ...
        },
        {
          ...
          date: "2023-06-02",
          time: "14:00-16:00",
          purpose: "Physics Lab Class",
          status: "pending"
        },
        {
          id: 3,
          classroom: "Auditorium 501",
          date: "2023-06-03",
          time: "08:00-10:00",
