<template>
  <div class="resources-upload">
    <div class="page-header">
      <h1>Upload Course Resources</h1>
      <p class="page-description">Upload announcements, files, and other resources related to the course</p>
    </div>
    ...
    <section class="card form-card">
      <form @submit.prevent="handleSubmit" class="upload-form">
        ...
        <div class="form-group">
          ...
          <div class="file-upload">
            ...
            <button type="button" class="file-select-button" @click="triggerFileSelect">
              {{ selectedFile ? 'Re-select File' : 'Select File' }}
            </button>
        ...
        <div class="form-group">
          ...
          <textarea id="description" v-model="formData.description" class="form-textarea" placeholder="Please enter resource description (optional)"
            rows="4"></textarea>
        </div>

        <!-- 操作按钮 -->
        <div class="form-actions">
          <button type="button" class="button button--secondary" @click="handleReset">Reset</button>
